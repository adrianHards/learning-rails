There are two ways to use React with RoR. The first is to build two separate, standalone apps, with the React app on a different repository, communicating with the backend via an API. <br><br>
